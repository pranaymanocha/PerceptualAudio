...
def argument_parser():
    ...
    parser.add_argument('--dataset_used', help='triplet (mymetric or fftnet) OR MOS(voco,fftnet,bwe,jiaqi,noizeus,peass,voice_conversion)', default='fftnet', type=str)
    ...
    parser.add_argument('--just_correlation', help='Distance file is already made, just run', default=0, type=int)
    parser.add_argument('--just_correlation_path', help='Distance file is already made, just run', default='triplet_fftnet_m89.p', type=str)
    parser.add_argument('--HUB_SPO', help='HUB(0) or SPO(1)', default=0, type=int)
...
if args.just_correlation==0:
    ...
    score=get_score(args,args.just_correlation_path,A_triplet_mymetric,A_triplet_fftnet,dataset)
